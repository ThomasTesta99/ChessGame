...
/**
 * A movement that moves straight, parallel to the edges.
 */
public class OrthogonalMovement implements Movement,Serializable
{	/**
	 * A constant String representing the name of the movement.
	 */
	public static final String movementName = "Orthogonal Movement";
